...
**Supervision** is a Python library for building and deploying customizable computer vision models. It's a lightweight, easy-to-use tool that allows you to build custom models with a minimal amount of code.
...
Supervision was designed to be easy to use. It's a lightweight, easy-to-use tool that allows you to build custom models with a minimal amount of code. For your conveice, we have created [connector](https://supervision.roboflow.com/latest/detection/core/#detections) for the most popular libraries like Ultralytics, Transformers, or MMDetection.
